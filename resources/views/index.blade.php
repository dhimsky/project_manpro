    ...
    <section class="categories-section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="right-btn"><a href="./catalog.html" class="primary-btn">VIew all</a></div>
          </div>
        </div>
        <div class="categories-slider owl-carousel">
          <div class="cs-item">
            <div class="cs-pic set-bg" data-setbg="img/categories/wedding.png"></div>
            <div class="cs-text">
              <h4>Wedding</h4>
          ...
          <div class="cs-item">
            <div class="cs-pic set-bg" data-setbg="img/categories/group.png"></div>
            <div class="cs-text">
              <h4>Group</h4>
          ...
          <div class="cs-item">
            <div class="cs-pic set-bg" data-setbg="img/categories/maternity.png"></div>
            <div class="cs-text">
              <h4>Maternity</h4>
          ...
          <div class="cs-item">
            <div class="cs-pic set-bg" data-setbg="img/categories/product.png"></div>
            <div class="cs-text">
              <h4>Product</h4>
              <span>120 pictures</span>
            </div>
          ...
          <div class="cs-item">
            <div class="cs-pic set-bg" data-setbg="img/categories/family.png"></div>
            <div class="cs-text">
              <h4>Family</h4>
              <span>120 pictures</span>
            </div>
          ...
          <div class="col-lg-12">
            <div class="copyright-text">
              <p>
                ...
                All rights reserved | <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              </p>
            </div>
          </div>
